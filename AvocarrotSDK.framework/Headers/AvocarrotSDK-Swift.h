...
- (void)loadImage:(NSString * _Nonnull)urlString onImageLoad:(void (^ _Nullable)(void))onImageLoad onImageLoadError:(void (^ _Nullable)(NSString * _Nonnull error))onImageLoadError;
@end
...
@property (nonatomic, readonly, strong) NSIndexPath * _Nullable av_indexPathForSelectedRow;
